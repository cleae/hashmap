...
public class Knapsack {
    ...
    static int _01knapsack(int[] w, int[] v, int N, int W){
        ...
        //状态转移方程 dp[n][w] 当背包且能容纳 w 的重量时，放入前 n 件物品的最大价值
    ...
    //状态转移方程优化
    static int _01knapsack2(int[] w, int[] v, int N, int W){

        //状态转移方程 dp[w] 当背包且能容纳 w 的重量时最大价值
        int dp []  =new int[W+1];
    ...
    public static void main(String[] args) {
        ...
        int total2 = _01knapsack2(w, v, N, W);
        System.out.println("能放入背包的最大价值为:"+ total2);

        Integer test=1;
        System.out.println("1".equals(test));
    }
}
